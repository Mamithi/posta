...
{
   public function pesapalIframe(Request $request){
        ...
        $consumer_key = "sVdDmKoKp8F5nBLDd/NzSLJkXKvEMrvV";
        ...
        // www.pesapal.com
        $consumer_secret = 'Z/6XyZVzvwZDaktK+Xl/WzDUDmU=';
        ...
        $type           = $request->input('type');                       // default value = MERCHANT
        $reference      = $request->input('reference');                  // unique order id of the transaction, generated by merchant
        $first_name     = $request->input('first_name');                 // optional 
        $last_name      = $request->input('last_name');                  // optional
        $email          = $request->input('email');
        $phonenumber    = $request->input('phone');;                                   // ONE of email or phonenumber is required
